...
from pytorch.event_extraction.event_case1.train_data_v2 import bert_train_list, label2id, role2id
    ...
    def _create_collate_fn(self, batch_first=False):
        def collate(documents):
            ...
            for document in documents:
                ...
                batch_gold_answer.append(document["entity"])
...
if __name__ == "__main__":
    ...
    train_data_list = bert_train_list
    ...
    msa_train_dataset = EventDataset(train_data_list, tokenizer, label2id)
