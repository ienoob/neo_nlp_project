...
remove_title = ["心理学", "设计模式", "2003年7月", "Wiki", "操作系统列表", "亳州市", "材料科学", "中国历史", "语言列表",
            ...
            "布莱尔", "乔治·布什", "长城 (消歧义)", "华盛顿", "荷兰同性婚姻", "美国同性婚姻", "管弦乐团列表", "歌剧魅影 (音乐剧)", "韩国 (消歧义)", "大阪 (消歧义)", "夏商周年表",
                ...
                "中非", "国家标准", "国标", "数据", "方太", "东区", "红军", "需求", "六十甲子", "夏雨", "泰坦尼克号 (1997年电影)", "法国总统列表", "一塌糊涂", "加州 (消歧义)", "熊 (消歧义)", "老挝语",
                "澎湖 (消歧义)", "罗马假日 (消歧义)", "天文学家列表", "叮当", "IDE", "台湾交通", "DTD", "雷神之锤 (消歧义)", "空气污染", "2004年夏季奥林匹克运动会", "2000年夏季奥林匹克运动会",
                "艺术类型列表", "武夷山", "贸易学", "老挝", "非确定型图灵机", "1996年夏季奥林匹克运动会", "1992年夏季奥林匹克运动会", "连通空间", "1988年夏季奥林匹克运动会", "1984年夏季奥林匹克运动会",
                "安南", "拓扑"
...
add_title = ["肖申克的救赎", "Windows 2000", "Microsoft Windows", "Windows 98", "Windows 95", "红白机", "霸王别姬 (电影)",
             ...
             "大城小事 (电影)", "重庆森林", "射雕英雄传之东成西就", "赌圣", "心动", "人民公厕", "春光乍泄", "十七岁的天空", "绝世好Bra", "台湾关系法", "北非谍影",
             "星际争霸：母巢之战", "烃", "德沃夏克分析法", "夔", "螭"]
