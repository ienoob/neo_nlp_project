...
from bert_use.bert import optimization
from bert_use.bert import tokenization
import tensorflow as tf
from bert_use import ner_metrics as metrics
import numpy as np
...
if __name__ == "__main__":
    ...
    """
        python BERT_NER.py --task_name=ner   --do_lower_case=False --crf=False --do_train=True   --do_eval=True   --do_predict=True --data_dir=ner2data    --vocab_file=pretrained_model/cased_L-12_H-768_A-12/vocab.txt  --bert_config_file=pretrained_model/cased_L-12_H-768_A-12/bert_config.json  --init_checkpoint=pretrained_model/cased_L-12_H-768_A-12/bert_model.ckpt    --max_seq_length=128   --train_batch_size=32   --learning_rate=2e-5    --num_train_epochs=3.0    --output_dir=./output/result_dir
