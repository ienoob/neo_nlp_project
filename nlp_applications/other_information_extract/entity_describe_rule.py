...
filter_p = {"是"}
role_list = ["ARG0", "PRED", "ARG1", "ARG2"]
i = 0
condition = dict()
df = []

def single_process(in_sentence):
    documents = HanLP(in_sentence)
    input_document_srl = documents["srl"]
    print(input_document_srl)
...
#     print(sentence)
#     single_process(sentence["sentence"])
#     i += 1
...
if __name__ == "__main__":
    single_process("思想政治教育公信力主要是指思想政治教育可以获得社会成员信任的能力，它代表着公众对其价值的认同，在一定程度上可以反映思想政治教育的权威性、认可度和影响力［1］")
